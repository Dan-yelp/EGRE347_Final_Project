...
class GPS:
    ...
    def read_byte(self,e):
        ...
        print('length of data:', len(self.Data_string))
        print('Type:',self.Type_string)
        if((self.State == "Writing") & (len(self.Data_string) == 69) & (self.Type_string == 'GPGGA')):
